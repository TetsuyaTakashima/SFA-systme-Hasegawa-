    ...
    <div>
      ...
      <div className="overflow-x-auto">
        <table className="w-full min-w-[760px] text-sm">
          <thead className="bg-muted/60 text-left text-xs text-muted-foreground"><tr><th className="h-10 px-4 font-medium">表示名</th><th className="px-4 font-medium">ログインID</th><th className="px-4 font-medium">権限</th><th className="px-4 font-medium">状態</th><th className="w-28 px-4" /></tr></thead>
